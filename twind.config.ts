...
export default {
  ...
  preflight: {
    ...
    nav: apply`font-content`,
    h1: apply`m-auto font-heading text-texas-rose-500`,
    h2: apply`m-auto font-heading text-potters-clay-600`,
    h3: apply`font-heading text-wild-willow-400`,
    p: apply`font-content font-normal leading-snug text-gray-500`,
  },
  theme: {
    extend: {
      fontFamily: {
